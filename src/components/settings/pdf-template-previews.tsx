...
export function MinimalTemplatePreview({ className }: PreviewProps) {
  return (
    <div
      className={cn(
        'aspect-[210/297] overflow-hidden rounded-lg border border-slate-200 bg-white p-3 shadow-sm',
        className
      )}
    >
      ...
      <div className="ml-auto mt-4 w-16 space-y-1">
...
export function PdfTemplatePreview({
  ...
  switch (template) {
    ...
    case 'MINIMAL':
    case 'MONO':
      return <MinimalTemplatePreview className={className} />;
    case 'BLUE_PRO':
      return <ModernTemplatePreview className={className} />;
    case 'CORPORATE':
...
export function resolveCatalogTemplate(org: {
  ...
  if (org.invoicePdfTemplate === 'MODERN' || org.invoicePdfTemplate === 'BLUE_PRO') return 'MODERN';
  if (org.invoicePdfTemplate === 'MINIMAL' || org.invoicePdfTemplate === 'MONO') return 'MINIMAL';
...
export function catalogToBackendTemplate(
  ...
  if (catalogId === 'MODERN' || catalogId === 'BLUE_PRO') return 'MODERN';
