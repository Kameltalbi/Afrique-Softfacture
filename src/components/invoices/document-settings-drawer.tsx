  ...
  return (
    <>
                    ...
                    localSettings.appliedDepositId !== null ? (
                      availableDeposits.length ? (
                        <select
                          ...
                          className="mt-2 w-full rounded-lg border border-s-border bg-white px-3 py-2 text-sm text-s-navy focus:outline-none focus:ring-2 focus:ring-[#2663eb]/25"
                        >
            ...
            <Section title="Langue du document">
              <div className="py-4">
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-s-border bg-white px-3 py-2.5 text-sm text-s-navy focus:outline-none focus:ring-2 focus:ring-[#2663eb]/25"
                >
      ...
      <div className="flex shrink-0 items-center justify-between gap-3 border-t border-s-border bg-white px-6 py-4">
        ...
        <Button
          type="button"
          className="gap-2 bg-[#2663eb] px-5 text-white hover:bg-[#1d4ed8]"
          onClick={onSave}
        >
