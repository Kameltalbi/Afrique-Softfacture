...
export async function sendPasswordResetEmail(options: {
  ...
  const html = `
    ...
    <p><a href="${options.resetUrl}" style="display:inline-block;padding:12px 20px;background:#2663eb;color:#fff;text-decoration:none;border-radius:8px;">Choisir un nouveau mot de passe</a></p>
