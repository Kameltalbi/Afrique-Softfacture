...
| Offre    | HT / mois | Équiv. annuel / mois |
| -------- | --------- | -------------------- |
| Gratuit  | 0 €       | 0 €                  |
| Pro      | 9,90 €    | ~7,90 €              |
| Business | 24,90 €   | ~19,90 €             |
...
Le plan **Gratuit** n’utilise pas Stripe (activation immédiate).
...
`STRIPE_PRICE_PRO` / `STRIPE_PRICE_BUSINESS` : optionnel (Price ID Dashboard à la place de `price_data`).
